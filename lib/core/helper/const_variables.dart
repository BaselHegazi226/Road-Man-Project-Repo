...
const Color kIconSettingsColor = Color(0xff131314);
const Color kTextTextFormFieldColor = Color(0xff131314);
const Color kHintTextFormFieldColor = Color(0xff131314);
...
const Color kEditProfileHintTextColor = Color(0xff131314);
