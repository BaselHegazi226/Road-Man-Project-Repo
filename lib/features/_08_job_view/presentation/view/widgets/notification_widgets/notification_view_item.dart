...
import 'package:road_man_project/features/_08_job_view/data/model/notification_view_item_model.dart';
...
class NotificationViewItem extends StatelessWidget {
  const NotificationViewItem({
    super.key,
    required this.notificationViewItemModel,
  });
  final NotificationViewItemModel notificationViewItemModel;
  @override
            ...
            child: Column(
              ...
              children: [
                NotificationMessageSection(
                  notificationText: notificationViewItemModel.notificationText,
                ),
                NotificationAccessTimeSection(
                  hour: notificationViewItemModel.dateTime,
                ),
              ],
            ),
          ),
