                ...
                return Padding(
                  ...
                  child: RecentJobsCard(
                    recentJobsCardModel: JobViewCardModel(
                      ...
                      logo: recentJobsCardItemModelList[0].logo,
                      salary: job.salary ?? '',
                      salaryType: recentJobsCardItemModelList[0].salaryType,
                      jobType: job.jobType ?? '',
                      jobLevel: recentJobsCardItemModelList[0].jobLevel,
                      timeLeft: recentJobsCardItemModelList[0].timeLeft ?? '',
                    ),
                  ),
                );
              },
